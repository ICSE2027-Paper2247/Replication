...
We are actively developing an improved version of **SiD-LSG**, which will be placed in a separate branch and introduce the following enhancements (Update: The features described below are now available in [sid-dit code](https://github.com/apple/ml-sid-dit). Our team at UT Austin has released the SiD-DiT distilled checkpoints for SANA, SD3-Medium, SD3.5-Medium, SD3.5-Large, and FLUX.1-dev on Hugging Face: [sid-dit project page](https://yigu1008.github.io/SiD-DiT/):  
