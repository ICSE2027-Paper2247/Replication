...
dependencies {
    ...
    implementation 'com.josesamuel:remoter-annotations:2.1.0'
    kapt 'com.josesamuel:remoter:2.1.0'
	
	//For KSP 
	//ksp 'com.josesamuel:remoter:2.1.0'
    ...
    implementation 'com.josesamuel:remoter-builder:2.1.0'
